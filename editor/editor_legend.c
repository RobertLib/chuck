...
const EdSymbol ED_SYMBOLS[] = {
    ...
    {'=', "Duct",
     "Trunking: wall to everyone on their feet, a way through to a crawl. Interiors only",
     ED_GROUP_TERRAIN, 70, 84, 99, true, true, false},
    ...
    {'F', "Falling panel", "Only Chuck's weight arms it; then it is gone for the visit",
