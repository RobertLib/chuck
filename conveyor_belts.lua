local conveyor_belts = {}

function conveyor_belts.create(x, y, width, height, speed, direction)
  return {
    x = x,
    y = y,
    width = width,
...
function conveyor_belts.update(belts, dt)
...
function conveyor_belts.draw(belts)
  for _, belt in ipairs(belts) do
...
function conveyor_belts.isPlayerOnBelt(player, belt)
...
function conveyor_belts.applyBeltEffect(belts, player, dt)
  for _, belt in ipairs(belts) do
    if conveyor_belts.isPlayerOnBelt(player, belt) then
