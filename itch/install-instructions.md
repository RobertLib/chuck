...
**In a browser** — Press PLAY. Nothing to install, and it holds your progress
between visits in the browser's own storage for this page, so clearing site data
for itch.io starts the tower again. A keyboard is required; a gamepad works if
one is plugged in. Sound arrives on the first click, which is a rule browsers
apply to every page rather than anything about this game.
...
**On the downloads** — Settings and progress live in one folder and nowhere else:
