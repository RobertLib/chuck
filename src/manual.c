...
static const ManualLine PAGE_MISSION[] = {
    ...
    {LINE_BULLET, "Three lives. Guards, dogs, spikes, fans"},
    {LINE_BODY, "and blasts each cost one."},
    {LINE_BULLET, "Out of lives, a CONTINUE puts you back"},
    {LINE_BODY, "at the start of the same sector. There"},
    {LINE_BODY, "are three of those."},
};
