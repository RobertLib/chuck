...
function stalactites.update(gameState, dt)
  ...
  for _, stalactite in ipairs(gameState.stalactites) do
    ...
    elseif stalactite.fallen and stalactite.debrisTimer > 0 then
      ...
      if stalactite.debrisTimer <= 0 then
        -- Reset stalactite after debris disappears
        stalactite.fallen = false
        stalactite.hasBeenTriggered = false
        stalactite.y = stalactite.originalY
      end
    end
  end
end
  ...
  for _, stalactite in ipairs(gameState.stalactites) do
    ...
    if stalactite.fallen and stalactite.debrisTimer > 0 then
      ...
      for i = 0, segments - 1 do
        ...
        local segmentX = x + (width - segmentWidth) / 2
